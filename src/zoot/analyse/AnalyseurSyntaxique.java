...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sat Feb 19 12:17:37 CET 2022
  */
public class AnalyseurSyntaxique extends java_cup.runtime.lr_parser {
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\040\000\006\004\004\006\006\001\002\000\006\010" +
    "\022\016\020\001\002\000\004\002\040\001\002\000\006" +
    "\011\012\012\010\001\002\000\010\004\ufffd\011\ufffd\012" +
    "\ufffd\001\002\000\004\016\036\001\002\000\010\004\015" +
    "\011\012\012\010\001\002\000\004\016\013\001\002\000" +
    "\004\007\014\001\002\000\010\004\ufff5\011\ufff5\012\ufff5" +
    "\001\002\000\006\010\022\016\020\001\002\000\010\004" +
    "\ufffe\011\ufffe\012\ufffe\001\002\000\010\005\ufffb\010\ufffb" +
    "\016\ufffb\001\002\000\004\014\031\001\002\000\010\005" +
    "\030\010\022\016\020\001\002\000\006\015\023\016\024" +
    "\001\002\000\004\007\ufff7\001\002\000\004\007\ufff6\001" +
    "\002\000\004\007\026\001\002\000\010\005\ufffa\010\ufffa" +
    "\016\ufffa\001\002\000\010\005\ufffc\010\ufffc\016\ufffc\001" +
    "\002\000\004\002\000\001\002\000\010\015\023\016\024" +
    "\017\032\001\002\000\004\007\035\001\002\000\004\007" +
    "\034\001\002\000\010\005\ufff8\010\ufff8\016\ufff8\001\002" +
    "\000\010\005\ufff9\010\ufff9\016\ufff9\001\002\000\004\007" +
    "\037\001\002\000\010\004\ufff4\011\ufff4\012\ufff4\001\002" +
    "\000\004\002\001\001\002\000\010\005\042\010\022\016" +
    "\020\001\002\000\004\002\uffff\001\002" });
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\040\000\004\002\004\001\001\000\006\003\040\006" +
    "\016\001\001\000\002\001\001\000\006\004\010\005\006" +
    "\001\001\000\002\001\001\000\002\001\001\000\004\005" +
    "\015\001\001\000\002\001\001\000\002\001\001\000\002" +
    "\001\001\000\006\003\020\006\016\001\001\000\002\001" +
    ...
    "\001\000\004\006\026\001\001\000\002\001\001" });
  ...
  public final java_cup.runtime.Symbol CUP$AnalyseurSyntaxique$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$AnalyseurSyntaxique$act_num)
        {
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 13: // DCL ::= BOOLEEN IDF POINTVIRGULE 
            {
		...
		String i = (String)((java_cup.runtime.Symbol) CUP$AnalyseurSyntaxique$stack.elementAt(CUP$AnalyseurSyntaxique$top-1)).value;
		 TDS.getInstance().ajouter(i, new Symbole(0, "booleen")) ; 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 12: // DCL ::= ENTIER IDF POINTVIRGULE 
            {
              ArbreAbstrait RESULT =null;
		int ileft = ((java_cup.runtime.Symbol)CUP$AnalyseurSyntaxique$stack.elementAt(CUP$AnalyseurSyntaxique$top-1)).left;
		int iright = ((java_cup.runtime.Symbol)CUP$AnalyseurSyntaxique$stack.elementAt(CUP$AnalyseurSyntaxique$top-1)).right;
		String i = (String)((java_cup.runtime.Symbol) CUP$AnalyseurSyntaxique$stack.elementAt(CUP$AnalyseurSyntaxique$top-1)).value;
		 TDS.getInstance().ajouter(i, new Symbole(0, "entier")) ; 
              CUP$AnalyseurSyntaxique$result = parser.getSymbolFactory().newSymbol("DCL",3, ((java_cup.runtime.Symbol)CUP$AnalyseurSyntaxique$stack.elementAt(CUP$AnalyseurSyntaxique$top-2)), ((java_cup.runtime.Symbol)CUP$AnalyseurSyntaxique$stack.peek()), RESULT);
            }
          return CUP$AnalyseurSyntaxique$result;
		...
		String c = (String)((java_cup.runtime.Symbol) CUP$AnalyseurSyntaxique$stack.peek()).value;
		 RESULT = new ConstanteEntiere(c, cleft + 1) ; 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 9: // INST ::= IDF EGAL EXP POINTVIRGULE 
            {
		...
		Expression e = (Expression)((java_cup.runtime.Symbol) CUP$AnalyseurSyntaxique$stack.elementAt(CUP$AnalyseurSyntaxique$top-1)).value;
		 RESULT = new Affectation(new Idf(i,ileft+1), e, eleft+1) ; 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 8: // INST ::= IDF EGAL CSTBOOLEEN POINTVIRGULE 
            {
              Instruction RESULT =null;
		int ileft = ((java_cup.runtime.Symbol)CUP$AnalyseurSyntaxique$stack.elementAt(CUP$AnalyseurSyntaxique$top-3)).left;
		int iright = ((java_cup.runtime.Symbol)CUP$AnalyseurSyntaxique$stack.elementAt(CUP$AnalyseurSyntaxique$top-3)).right;
		...
		String b = (String)((java_cup.runtime.Symbol) CUP$AnalyseurSyntaxique$stack.elementAt(CUP$AnalyseurSyntaxique$top-1)).value;
		 RESULT = new Affectation(new Idf(i,ileft+1), new Booleen(b, ileft+1), ileft+1) ; 
              CUP$AnalyseurSyntaxique$result = parser.getSymbolFactory().newSymbol("INST",4, ((java_cup.runtime.Symbol)CUP$AnalyseurSyntaxique$stack.elementAt(CUP$AnalyseurSyntaxique$top-3)), ((java_cup.runtime.Symbol)CUP$AnalyseurSyntaxique$stack.peek()), RESULT);
            }
          return CUP$AnalyseurSyntaxique$result;
